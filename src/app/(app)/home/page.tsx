...
const BASE_TILES: Tile[] = [
  ...
  { href: '/vereine',         label: 'Vereine',              icon: Users,                 color: '#7c3aed', bg: 'rgba(124,58,237,0.1)', desc: 'Vereine & Organisationen' },
  { href: '/buergermeister',  label: 'Frag den Bürgermeister', icon: MessageCircleQuestion, color: '#1a5cbf', bg: 'rgba(26,92,191,0.1)',  desc: 'An die Verwaltung' },
